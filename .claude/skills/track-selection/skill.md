...
description: PRD와 위험분석을 바탕으로 기관 프로파일에서 허용한 표준 Track을 결정할 때 사용한다. 공무원에게 기술을 묻지 않고 규칙으로 정한다.
---

# track-selection

## 결정 규칙
- 먼저 `shared/institution-profile.yaml`의 `tracks.enabled`와 denied 항목을 확인한다.
